...
static constexpr unsigned char qt_pluginMetaData[] = {
    ...
    't',  'c',  'h',  0xa6,  0x6c,  'd',  'e',  'f', 
    'a',  'u',  'l',  't',  'V',  'a',  'l',  'u', 
    'e',  0x18,  0xc8,  0x65,  'l',  'a',  'b',  'e', 
    'l',  0x6d,  'P',  'i',  'x',  'e',  'l',  ' ', 
    'd',  'e',  'n',  's',  'i',  't',  'y',  0x64, 
    'n',  'a',  'm',  'e',  0x63,  'd',  'p',  'i', 
    0x66,  's',  'u',  'f',  'f',  'i',  'x',  0x63, 
    'D',  'P',  'I',  0x68,  't',  'e',  'x',  't', 
    'T',  'y',  'p',  'e',  0x63,  'i',  'n',  't', 
    0x64,  't',  'y',  'p',  'e',  0x69,  't',  'e', 
    'x',  't',  'f',  'i',  'e',  'l',  'd',  0xa5, 
    0x6c,  'd',  'e',  'f',  'a',  'u',  'l',  't', 
    'V',  'a',  'l',  'u',  'e',  0x61,  '1',  0x65, 
    'l',  'a',  'b',  'e',  'l',  0x6a,  'R',  'e', 
    's',  'o',  'l',  'u',  't',  'i',  'o',  'n', 
    0x64,  'n',  'a',  'm',  'e',  0x6a,  'r',  'e', 
    's',  'o',  'l',  'u',  't',  'i',  'o',  'n', 
    0x64,  't',  'y',  'p',  'e',  0x68,  'c',  'o', 
    'm',  'b',  'o',  'b',  'o',  'x',  0x66,  'v', 
    'a',  'l',  'u',  'e',  's',  0xa3,  0x61,  '1', 
    0x67,  '8',  '0',  '0',  'x',  '4',  '8',  '0', 
    0x61,  '2',  0x68,  '1',  '2',  '8',  '0',  'x', 
    '7',  '2',  '0',  0x61,  '3',  0x69,  '1',  '9', 
    '2',  '0',  'x',  '1',  '0',  '8',  '0',  0xa5, 
    0x6c,  'd',  'e',  'f',  'a',  'u',  'l',  't', 
    'V',  'a',  'l',  'u',  'e',  0x61,  '1',  0x65, 
    'l',  'a',  'b',  'e',  'l',  0x6a,  'F',  'r', 
    'a',  'm',  'e',  ' ',  'r',  'a',  't',  'e', 
    0x64,  'n',  'a',  'm',  'e',  0x6a,  'f',  'r', 
    'a',  'm',  'e',  '_',  'r',  'a',  't',  'e', 
    0x64,  't',  'y',  'p',  'e',  0x68,  'c',  'o', 
    'm',  'b',  'o',  'b',  'o',  'x',  0x66,  'v', 
    'a',  'l',  'u',  'e',  's',  0xa2,  0x61,  '1', 
    0x66,  '3',  '0',  ' ',  'F',  'P',  'S',  0x61, 
    '2',  0x66,  '6',  '0',  ' ',  'F',  'P',  'S', 
    ...
    0x68,  'c',  'o',  'm',  'b',  'o',  'b',  'o', 
    'x',  0x66,  'v',  'a',  'l',  'u',  'e',  's', 
    0xa2,  0x67,  'n',  'e',  't',  'w',  'o',  'r', 
    'k',  0x67,  'N',  'e',  't',  'w',  'o',  'r', 
    'k',  0x63,  'u',  's',  'b',  0x63,  'U',  'S', 
    'B',  0xa9,  0x6f,  'c',  'o',  'n',  'd',  'i', 
    't',  'i',  'o',  'n',  'T',  'a',  'r',  'g', 
    'e',  't',  0x6e,  't',  'r',  'a',  'n',  's', 
    'p',  'o',  'r',  't',  '_',  't',  'y',  'p', 
    'e',  0x6e,  'c',  'o',  'n',  'd',  'i',  't', 
    ...
    't',  'e',  'x',  't',  'O',  'f',  'f',  0x63, 
    'O',  'f',  'f',  0x66,  't',  'e',  'x',  't', 
    'O',  'n',  0x62,  'O',  'n',  0x64,  't',  'y', 
    'p',  'e',  0x66,  's',  'w',  'i',  't',  'c', 
    'h',  0x67,  's',  'e',  'c',  't',  'i',  'o', 
    'n',  0x6a,  'M',  'e',  'd',  'i',  'a',  ' ', 
    'a',  'p',  'p',  's',  0x64,  't',  'y',  'p', 
    'e',  0x65,  'i',  't',  'e',  'm',  's',  0x64, 
    'i',  'c',  'o',  'n',  0x78,  0x23,  'q',  'r', 
    'c',  ':',  '/',  'A',  'n',  'd',  'r',  'o', 
    'i',  'd',  'A',  'u',  't',  'o',  '/',  's', 
    'o',  'c',  'i',  'a',  'l',  '-',  'a',  'n', 
    'd',  'r',  'o',  'i',  'd',  '.',  's',  'v', 
    'g',  0x65,  'l',  'a',  'b',  'e',  'l',  0x6c, 
    'A',  'n',  'd',  'r',  'o',  'i',  'd',  ' ', 
    'A',  'u',  't',  'o',  0x64,  'n',  'a',  'm', 
    'e',  0x6b,  'A',  'n',  'd',  'r',  'o',  'i', 
    'd',  'A',  'u',  't',  'o',  0x66,  's',  'o', 
    'u',  'r',  'c',  'e',  0x78,  0x1d,  'q',  'r', 
    'c',  ':',  '/',  'A',  'n',  'd',  'r',  'o', 
    'i',  'd',  'A',  'u',  't',  'o',  '/',  'n', 
    'a',  't',  'i',  'v',  'e',  'A',  'A',  '.', 
    'q',  'm',  'l', 
